...
public class AppModule {
    ...
    static final Migration MIGRATION_DB = new Migration(8, 10) {
        @Override
...
*/
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS AddBoreWellSeasonTable (BorewellID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,LogBookNo TEXT," +
                    "Date TEXT,HoursDay INTEGER,sync INTEGER NOT NULL,serverStatus TEXT," +
                    "IsActive TEXT,CreatedDate TEXT,CreatedByUserId TEXT,UpdatedDate TEXT,UpdatedByUserId TEXT)");

//            // Copy the data
            database.execSQL("INSERT INTO AddBoreWellSeasonTable (BorewellID, LogBookNo, Date, HoursDay, sync, serverStatus" +
                    "IsActive,CreatedDate,CreatedByUserId,UpdatedDate,UpdatedByUserId) SELECT BorewellID, LogBookNo, Date, HoursDay, sync, serverStatus, IsActive, CreatedDate, CreatedByUserId, UpdatedDate, UpdatedByUserId FROM AddBoreWellPumpSeasonTable");
            ...
            // Remove the old table
            database.execSQL("DROP TABLE AddBoreWellPumpSeasonTable");
...
//            database.execSQL("DROP TABLE users");
   ...
   /* static final Migration MIGRATION_DB = new Migration(8, 9) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            // TODO: Migration 8 to 9 Released APK
            // TODO: 3/3/2022 update new tables by removing of old tables
...
//            // Change the table name to the correct one
            ...
            // TODO: AddBoreWellPumpSeasonTable
            database.execSQL("CREATE TABLE IF NOT EXISTS AddBoreWellPumpSeasonTable (BorewellID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,LogBookNo TEXT," +
                    "Date TEXT,HoursDay INTEGER NOT NULL,sync INTEGER NOT NULL,serverStatus TEXT," +
                    "IsActive TEXT,CreatedDate TEXT,CreatedByUserId TEXT,UpdatedDate TEXT,UpdatedByUserId TEXT)");
