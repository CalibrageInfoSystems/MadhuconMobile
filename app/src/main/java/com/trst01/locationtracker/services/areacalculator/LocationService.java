...
public class LocationService extends Service implements LocationListener {
    ...
    public static final String ACTION_START = "com.trst01.locationtracker.locationservice.start";
    public static final String ACTION_STOP_SRV = "com.trst01.locationtracker.locationservice.stop.srv";
    public static final String ACTION_STOP_LBS = "com.trst01.locationtracker.locationservice.stop.lbs";
    public static final String ACTION_LOCATION_UPDATED = "com.trst01.locationtracker.locationservice.location.updated";
